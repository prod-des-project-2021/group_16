...
public class Chessman : MonoBehaviour
{
    ...
    public void InitiateMovePlates()
    {
        switch (this.name)
        {
            ...
            case "white_rook":
                ...
                break;
            case "black_pawn":
                PawnNormalMovePlate(xBoard, yBoard - 1);
                BlackPawnFirstMovePlate(xBoard, yBoard - 2);
                break;
            case "white_pawn":
                PawnNormalMovePlate(xBoard, yBoard + 1);
                WhitePawnFirstMovePlate(xBoard, yBoard + 2);
                break;
        }
    }
    ...
    public void PawnNormalMovePlate(int x, int y)
    {
        Game sc = controller.GetComponent<Game>();
        if (sc.PositionOnBoard(x, y))
        {
    ...
    public void WhitePawnFirstMovePlate(int x, int y)
    {
        Game sc = controller.GetComponent<Game>();
        if (sc.PositionOnBoard(x, y))
        {
    ...
    public void BlackPawnFirstMovePlate(int x, int y)
    {
        Game sc = controller.GetComponent<Game>();
        if (sc.PositionOnBoard(x, y))
        {
